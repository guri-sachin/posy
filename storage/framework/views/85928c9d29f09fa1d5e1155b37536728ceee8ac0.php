...
<div class="ab5">
<div class="row">
<div class="col-md-5"><a href="/"><img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="logo"></a></div>
<div class="col-md-7">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="dropdown" style="margin-top:12px;">
                            ...
                            <li><a href="#" style="font-size:24px; font-weight:bold"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?><br> <span style="font-size:12px;color:#292929!important; position:relative; top:-2px">About your self</span></a></li>
...
</div><?php /**PATH /home/nchg6j95t6ui/public_html/posyai.omkatech.com/resources/views/navbars/header.blade.php ENDPATH**/ ?>
...
<div class="container-fluid ab2">
   <img src="<?php echo e(asset('images/_ii_lbws2ipy4_.jpeg')); ?>" alt="logo" class="ab1" width="110">
</div>
         ...
         <form id="myform">
            <div class="wrap">
               <div class="search">
                  ...
                  <div class="hideloader"><img src="<?php echo e(asset('public/images/typing-text.gif')); ?>" style="width: 80px;"></div>
               </div>
            </div>
         </form>
         <div class="col-md-2"></div>
...
<!-- Mohit Kumar -->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style_chat.css')); ?>">
<style type="text/css">
                ...
                <div class="card">
                    <div class="card-header text-left">
                        <span> <a class="avatar avatar-lg status-success mx-0" href="#">
                            <img src="<?php echo e(asset('images/ChatbotIcon .png')); ?>" class="rounded-circle" alt="..." width="55">
                            </a>
                    ...
                    <div class="card-body chat-care">
                        ...
                        <li class="admin clearfix">
                                <span class="chat-img right clearfix  mx-2">
                                    <img src="<?php echo e(asset('images/man.png')); ?>" alt="Admin" class="img-circle" width="50"/>
                                </span>
                            ...
                            <li class="agent clearfix">
                                <span class="chat-img left clearfix mx-2">
                                    <img src="<?php echo e(asset('images/ChatbotIcon .png')); ?>" alt="Agent" class="img-circle" width="50"/>
                                </span>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nchg6j95t6ui/public_html/posyai.omkatech.com/resources/views/home.blade.php ENDPATH**/ ?>